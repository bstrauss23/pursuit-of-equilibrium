    ...
    <footer className="border-t border-border">
      <div className="mx-auto grid w-full gap-8 px-4 py-10 md:grid-cols-2 md:px-6">
        <div className="space-y-3">
          <p className="text-base font-semibold uppercase tracking-wide">Ben Strauss</p>
        ...
        <div className="space-y-3">
          <p className="text-base font-semibold uppercase tracking-wide">Transient Labs</p>
          <div className="flex items-center gap-4 text-base text-muted-foreground">
      ...
      <div className="border-t border-border py-4">
        <p className="mx-auto w-full px-4 text-base text-muted-foreground md:px-6">
