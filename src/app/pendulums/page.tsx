      ...
      <div className="relative h-[50vh] w-full md:h-[80vh]">
        ...
        <div className="pointer-events-none absolute inset-x-0 top-1/3 flex -translate-y-1/2 flex-col items-center gap-6 px-4 text-center md:gap-8">
          <div className="flex w-full max-w-[1700px] items-center gap-3 md:gap-6">
            <span className="h-[2px] flex-1 bg-gradient-to-r from-transparent to-white/70" />
            <h1 className="text-4xl tracking-[0.2em] text-white md:text-9xl">PENDULUMS</h1>
            <span className="h-[2px] flex-1 bg-gradient-to-l from-transparent to-white/70" />
          </div>
          <h2 className="text-lg tracking-[0.08em] text-white md:text-3xl">
