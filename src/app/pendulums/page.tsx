...
import { DeferredHeroIframe } from "@/components/deferred-hero-iframe";
    ...
    <section className="relative -mx-4 -mt-8 flex flex-col items-start justify-start overflow-x-clip md:-mx-6">
      ...
      <article className="mx-auto content-width px-4 pt-0 pb-10 md:px-6 md:pb-12">
        <div className="space-y-5 text-center text-base leading-8 text-foreground md:text-left md:text-lg">
          ...
          <Figure caption="A real-world pendulum exposure, Lux No. 6 (left) vs. an early simulation preview (right) used to plan swing ratios.">
            <div className="w-full shadow-[0_2px_5px_#0003]">
              <Image src="/figure-1.jpg" alt="A real-world pendulum exposure beside an early simulation preview" width={2400} height={1350} className="block h-auto w-full object-contain" />
            </div>
          </Figure>
          ...
          <Figure caption="An early Lissajous pattern produced via a harmonograph by S.C. Tisley, circa late 1800s (left), alongside a simplified, similar output generated by my algorithm (right). The pattern above is from a 3:4 period ratio.">
            <div className="w-full shadow-[0_2px_5px_#0003]">
              <Image src="/figure-2.jpg" alt="Historic harmonograph Lissajous pattern beside an algorithmic output" width={2400} height={1350} className="block h-auto w-full object-contain" />
            </div>
          </Figure>
          ...
          <Figure caption="Screen shots from the algorithm, showing tunable physical parameters like damping, amplitude, period offset, period lengths, and phase offsets, all of which shape the final aesthetic of the output.">
            <div className="w-full shadow-[0_2px_5px_#0003]">
              <Image src="/figure-3.jpg" alt="Algorithm controls for pendulum system parameters" width={2400} height={1350} className="block h-auto w-full object-contain" />
            </div>
          </Figure>
          ...
          <Figure caption="Snapshots from the progression of a pendulum output in animated mode, showing the drawing as it unfolds in real time.">
            <div className="w-full shadow-[0_2px_5px_#0003]">
              <Image src="/figure-5.jpg" alt="Time progression snapshots of an animated pendulum output" width={2400} height={1350} className="block h-auto w-full object-contain" />
            </div>
          </Figure>
